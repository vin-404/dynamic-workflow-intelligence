...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Deliberate divergence from upstream shadcn: upstream highlights the
        // focused item with `bg-accent`/`text-accent-foreground`. In this app
        // the accent is one reserved colour (critical path, high severity), so
        // the highlight uses `muted`, matching how Button spells hover.
